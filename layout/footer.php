<!-- layout/footer.php -->
<footer style="background-color: #f6f6f6; color: #333; padding-top: 60px;">
    ...
    <div class="container text-center">
        <!-- Logo -->
        <div class="mb-4">
            <img src="assets/lumos.png" alt="Logo" style="height: 80px;">
        </div>
        ...
        <!-- Contact Info -->
        <div class="mb-4 pb-2" style="font-family: sans-serif;">
            <h6 style="font-weight: bold; font-size: 16px; color: #444; margin-bottom: 15px;">Get in Touch!</h6>
            <p style="margin-bottom: 2px; font-weight: bold; font-size: 14px; color: #555;">+94 75 838 5027</p>
            <p style="margin-bottom: 0; font-weight: bold; font-size: 14px; color: #555;">lumosstudio.lk@gmail.com</p>
        </div>
    </div>

    <!-- Copyright Strip -->
    <div style="background-color: #ededed; padding: 20px 0; font-family: sans-serif; font-size: 13px; color: #666;" class="text-center mt-3 border-top">
        Copyright &copy; <?php echo date("Y"); ?> Lumos Studio | Design by <strong style="color: #333;">Hathisa Thissara</strong>
    </div>
</footer>
